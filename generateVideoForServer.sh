...
# create video
cd output/"$1" &&
$(node ../../ffmpeg.js) -framerate 1 -pattern_type glob -i '*.jpg' -i audio -map 0:v -map 1:a -c:v libx264 -c:a aac -pix_fmt yuv420p -profile:v baseline -level 3 -r 30 -t 100.0 "$1".mp4
# cd - &&
cd -
