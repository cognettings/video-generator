...
node imageMagick.js "mogrify -format jpg -resize 1280x720 -gravity center -background black -extent 1280x720 *.image"
...
$(node ../ffmpeg.js) -framerate 1 -pattern_type glob -i '*.jpg' -map 0:v -vf "pad=ceil(iw/2)*2:ceil(ih/2)*2" -c:v libx264 -r 30 output.mp4
cd - &&
